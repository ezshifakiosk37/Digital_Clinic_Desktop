...
interface SuccessPopupProps {
  ...
  onDismiss: () => void
  title: string
  value?: string | number | null      // optional large value (e.g., glucose number)
  valueLabel?: string                 // unit displayed next to value (e.g., "mg/dL")
  message?: string                    // optional text when no value is shown
}
